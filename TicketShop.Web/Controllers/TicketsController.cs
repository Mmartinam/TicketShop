...
namespace WebApplication3.Controllers
{
    public class TicketsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Create([Bind("Id,MovieName,MovieImage,MovieDescription,TicketPrice,DateValid,Rating")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(Guid id, [Bind("Id,MovieName,MovieImage,MovieDescription,TicketPrice,DateValid,Rating")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
